...
- Landscape visual review remains available in the stage preview. Automated reload was blocked by browser URL policy after the local asset change; build and test checks remain green.
